...
public class Authentication extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Authentication", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 36), new java.awt.Color(0, 204, 204))); // NOI18N
...
try {
    ...
    if (rs.next()) {  // Removed the semicolon here
        setVisible(false);
    ...
    try {
        if (rs != null) rs.close();  // Ensure rs is not null before closing
        if (pst != null) pst.close();  // Ensure pst is not null before closing
    } catch (Exception e) {
