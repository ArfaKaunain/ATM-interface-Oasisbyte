...
public class mypage extends javax.swing.JFrame {
   ...
   public void Table1() {
    try {
        // Correct SQL query with space after 'select'
        String sql = "SELECT account_no, name, DOB, acc_type, gender, mob FROM account";
        pst = con.prepareStatement(sql);  // Preparing the SQL query
        rs = pst.executeQuery();  // Executing the query and getting the result set
        
        // Populating jTable1 with data from ResultSet using DbUtils
    ...
    try {
        // Correct SQL query with space after 'select'
        String sql = "SELECT name,account,MICRO_no,balance FROM balances";
        pst = con.prepareStatement(sql);  // Preparing the SQL query
        rs = pst.executeQuery();  // Executing the query and getting the result set
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jTextField15, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jButton10.setForeground(new java.awt.Color(0, 255, 0));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(22, 22, 22)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextField32, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField42, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGap(256, 256, 256)
        ...
        jLabel36.setForeground(new java.awt.Color(153, 255, 153));
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(jLabel34, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel35, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addComponent(jLabel37, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel38, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTabbedPane1.addTab("quit", jPanel10);
...
try {
    ...
    if (rs.next()) {  // Move cursor to the first row
        ...
        JOptionPane.showMessageDialog(null, "No account found with the given name.");
    }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            ...
            pst = con.prepareStatement(sql);  // Prepare the statement
    ...
    private void jComboBox1PopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_jComboBox1PopupMenuWillBecomeInvisible
        // TODO add your handling code here:
        // Method to fetch balance based on account selected in jComboBox1
        try{
        ...
        // Method to transfer (credit) money to one account
    ...
    String balanceString = jTextField16.getText();

    // Convert balanceString to integer and handle potential parsing errors
    int balanceValue;
    try {
        balanceValue = Integer.parseInt(balanceString);
    } catch (NumberFormatException ex) {
        JOptionPane.showMessageDialog(null, "Invalid balance amount. Please enter a valid integer.");
        return;
    }
    ...
    // Set parameters
    pst.setInt(1, balanceValue);  // Assuming balance is an integer
    ...
    if (rowsAffected > 0) {
        ...
        JOptionPane.showMessageDialog(null, "No records updated. Check if the name exists.");
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            // Set the result in jTextField18
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String value4 = jTextField10.getText(); // caste
            String value5 = jTextField11.getText(); // mobile
            String value6 = jTextField12.getText(); // security question
            String value7 = jTextField1.getText();  // name (in WHERE clause)
            ...
            pst.setString(1, value1);  // nationality
            pst.setString(2, value2);  // gender
            pst.setString(3, value3);  // address
            pst.setString(4, value4);  // caste
            pst.setString(5, value5);  // mobile
            pst.setString(6, value6);  // security question
            pst.setString(7, value7);  // name (in WHERE clause)
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        // TODO add your handling code here:
// Ensure you have initialized the PreparedStatement 'pst' somewhere before this block
String sql = "SELECT * FROM balances WHERE name = ?";
...
try {
    ...
    pst = con.prepareStatement(sql);
    pst.setString(1, jTextField33.getText()); // Set the value from text field
    rs = pst.executeQuery(); // Execute query

  if (rs.next()) {
        // Retrieve data from ResultSet and set to text fields
        String add1 = rs.getString("name");
        jTextField34.setText(add1);
        String add2 = rs.getString("account");
        jTextField35.setText(add2);
        String add3 = rs.getString("MICRO_no");
        jTextField36.setText(add3);
        String add4 = rs.getString("balance");
        jTextField38.setText(add4); 
        jTextField37.setText("4%");
        jTextField39.setText("Rs 0.00"); // Assuming this is a fixed value
    ...
    // Set parameters
    pst.setString(1, value2); // Set the new pin value
    pst.setString(2, value1); // Set the name to identify which record to update
    ...
    try {
        if (pst != null) pst.close(); // Close the PreparedStatement
    } catch (Exception e) {
        JOptionPane.showMessageDialog(null, e);
    }
}
